...
export class Init1770154512444 implements MigrationInterface {
  name = "Init1770154512444";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."invitation_role_enum" AS ENUM('owner', 'admin', 'fleet_manager', 'driver', 'member')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."invitation_status_enum" AS ENUM('pending', 'accepted', 'rejected', 'expired', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_tenant_role_enum" AS ENUM('owner', 'admin', 'fleet_manager', 'driver', 'member')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "operation" ADD CONSTRAINT "FK_ac1257bfe80d5cdd9c3fd2dece3" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "operation" ADD CONSTRAINT "FK_289c58cdde3f9e5e7d1c9111b6f" FOREIGN KEY ("vehicleId") REFERENCES "vehicle"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "operation" ADD CONSTRAINT "FK_710e023a12a046515d8fca7a2e3" FOREIGN KEY ("authorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_tenant" ADD CONSTRAINT "FK_b8a35c97c3c39e18d9f913c8098" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_tenant" ADD CONSTRAINT "FK_438336c75d48db09e9c18b0cdf2" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
